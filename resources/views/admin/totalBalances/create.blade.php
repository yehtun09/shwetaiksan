...
<div class="card">
    <div class="card-header">
        {{trans('global.create')}} {{trans('cruds.total_balance.title_singular')}}
    </div>
   
    <div class="card-body">
        <form method="POST" action="{{route('admin.total_balances.store')}}" enctype="multipart/form-data" id="myForm">
            @csrf
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        <label class="required" for="user_id">{{trans('cruds.total_balance.fields.user_id')}}</label>
                        <input class="form-control {{$errors->has('user_id') ? 'is-invalid' : ''}}" type="number" name="user_id" id="user_id" value="{{old('user_id', '')}}">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{$errors->has('total_balance') ? 'is-invalid' : ''}}" type="number" name="total_balance" id="total_balance" value="{{old('total_balance', '')}}">
